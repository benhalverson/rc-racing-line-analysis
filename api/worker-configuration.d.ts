/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 85c84db1b1ff26bbd9d55002cc2f573d)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ANALYSIS_PROGRESS_ROOMS: DurableObjectNamespace<import("./src/index").AnalysisProgressRoom>;
	ANALYSIS_PROCESSING: Workflow<Parameters<import("./src/index").AnalysisProcessingWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AnalysisProgressRoom";
	}
